...
fig.add_axes([.05, .57, .95, .37])
plt.plot(result_oasis[0], c=col[0], label='OASIS')
plt.plot(result_foopsi[0], '--', c=col[6], label='CVXPY')
plt.plot(trueC[0], c=col[2], lw=1.5, label='Truth', zorder=-5)
plt.plot(Y[0], c=col[7], alpha=.7, zorder=-10, label='Data')
plt.legend(frameon=False, ncol=4, loc=(.18, .84))
...
plt.ylabel('Fluor.')
plt.xlim(0, 2000)
fig.add_axes([.05, .18, .95, .37])
plt.plot(result_oasis[1], c=col[0])
plt.plot(result_foopsi[1], '--', c=col[6])
plt.plot(trueSpikes[0], c=col[2], lw=1, zorder=-10)
plt.gca().set_xticklabels([])
simpleaxis(plt.gca())
plt.yticks([0, 1], [0, 1])
...
fig = plt.figure(figsize=(15, 4))
fig.add_axes([.05, .57, .46, .37])
# plt.plot(result_onnls[0][150:1350], c=col[1], label='ONNLS')
plt.plot(result_oasis[0][150:1350], c=col[0], label='OASIS')
plt.plot(result_foopsi[0][150:1350], '--', c=col[6], label='CVXPY')
plt.plot(trueC[0][150:1350], c=col[2], lw=1.5, label='Truth', zorder=-5)
plt.plot(Y[0][150:1350], c=col[7], alpha=.7, zorder=-10, label='Data')
plt.gca().set_xticklabels([])
simpleaxis(plt.gca())
plt.xlim(0, 1200)
...
fig.add_axes([.05, .18, .46, .37])
# plt.plot(result_onnls[1][150:1350], c=col[1])
plt.plot(result_oasis[1][150:1350], c=col[0])
plt.plot(result_foopsi[1][150:1350], '--', c=col[6])
plt.plot(trueSpikes[0][150:1350], c=col[2], lw=1, zorder=-10)
plt.gca().set_xticklabels([])
simpleaxis(plt.gca())
plt.yticks([0, 1], [0, 1])
...
mu = .075
y = ((fmean_comp - b) / (b + 10)).astype(float) + mu  # + .05
...
plt.plot(t_frame[:2400], y[100:2500], c=col[7], alpha=.7, clip_on=False)
# plt.plot(t_frame[:2400], result_onnls[0][100:2500], c=col[1], clip_on=False, label='ONNLS')
...
plt.legend(frameon=False, loc=(.4, .84))
plt.xlim(0, 40)
plt.ylim(-.6, 2.2)
...
fig.add_axes([.54, .18, .46, .37])
for t in spike_time:
    plt.plot([t - 100. / 60, t - 100. / 60], [0, .2], c=col[2], lw=1)
# plt.plot(t_frame[:2400], result_onnls[1][100:2500], c=col[1])  # , alpha=.5)
